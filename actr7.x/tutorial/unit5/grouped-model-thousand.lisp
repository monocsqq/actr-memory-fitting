...
(sgp  :rt -.5 :ans .15 :esc t :mp 1.0 :v nil :act nil
     :declarative-num-finsts 4 ;; default
...
(add-dm
   ...
   (third isa chunk) (fourth isa chunk) (fifth isa chunk)
   ...
   (item0 ISA item name "0" group group3 position fourth)
...
(p harvest-first-item
  ...
  ==>
   ...
   +retrieval>
      ...
      position second 
      :recently-retrieved nil
   !eval! ("grouped-response" (list *given-port* =name)))
